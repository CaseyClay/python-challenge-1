...
while place_order:
    ...
    for v in menu.keys():
        ...
        menu_items[i] = v        # Add 1 to the menu item number v = [sneaks, meal, drinks, dessert]
        i += 1
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_item_number = input("type your selection: ")
            ...
            if menu_item_number.isdigit():
                ...
                if menu_item_number in menu_items.keys():
                    ...
                    item_quantity = input(f'How many would you like? ')
...
for item in order_list:
    ...
    print(f"{name}{name_space_str}| {price}{price_space_str}| {quantity}")
